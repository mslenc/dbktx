...
abstract class CompositeId7<E : DbEntity<E, ID>, T1: Any, T2: Any, T3: Any, T4: Any, T5: Any, T6: Any, T7: Any, ID : CompositeId7<E, T1, T2, T3, T4, T5, T6, T7, ID>>
    private constructor()
    : CompositeId<E, ID>() {
