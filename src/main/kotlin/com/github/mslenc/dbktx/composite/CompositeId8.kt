...
abstract class CompositeId8<E : DbEntity<E, ID>, T1: Any, T2: Any, T3: Any, T4: Any, T5: Any, T6: Any, T7: Any, T8: Any, ID : CompositeId8<E, T1, T2, T3, T4, T5, T6, T7, T8, ID>>
    private constructor()
    : CompositeId<E, ID>() {
    ...
    protected constructor(val1: T1, val2: T2, val3: T3, val4: T4, val5: T5, val6: T6, val7: T7, val8: T8) : this() {
