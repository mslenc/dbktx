...
internal constructor(
    ...
    fun nullableDateTime(fieldName: String, type: SqlTypeDef, getter: (E) -> LocalDateTime?
                         ): NullableColumn<E, LocalDateTime> {
