...
interface RowProp<E : DbEntity<E, *>, T: Any> {
    fun invoke(row: DbRow): T?

    val isAutoGenerated: Boolean
    fun extract(values: EntityValues<E>): T?
    fun makeLiteral(value: T): Expr<T>

    fun bindForSelect(tableInQuery: TableInQuery<E>): Expr<T>
}

interface NullableRowProp<E: DbEntity<E, *>, T: Any> : RowProp<E, T> {
