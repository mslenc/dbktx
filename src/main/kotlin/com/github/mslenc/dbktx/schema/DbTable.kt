...
open class DbTable<E : DbEntity<E, ID>, ID : Any> protected constructor(
    ...
    val outgoingRefs: List<RelToOne<E, *>>
        get() = _outgoingRefs

    val incomingRefs: List<RelToOne<*, E>>
        get() = _incomingRefs

    internal val _columns = ArrayList<Column<E, *>>()
    ...
    internal val _outgoingRefs = ArrayList<RelToOneImpl<E, *, *>>()
    internal val _incomingRefs = ArrayList<RelToOneImpl<*, E, *>>()
