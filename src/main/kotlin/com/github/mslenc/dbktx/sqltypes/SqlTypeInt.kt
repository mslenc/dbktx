...
class SqlTypeInt(concreteType: SqlTypeKind, isNotNull: Boolean, isAutoGenerated: Boolean, isUnsigned: Boolean) : SqlTypeNumeric<Int>(isNotNull, isAutoGenerated, isUnsigned) {
    ...
    companion object {
        ...
        private val INSTANCE_FOR_LITERALS = SqlTypeInt(SqlTypeKind.INT, isNotNull = true, isAutoGenerated = false, isUnsigned = false)

        fun makeLiteral(value: Int): Literal<Int> {
